  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Taught concepts as such probability, multivariable calculus, financial mathematics, and Object-Oriented-Programming.}
    ...
    \resumeSubheading
      {Assistant Front-End Supervisor}{October 2014 -- March 2021}
    ...
    \resumeSubheading
      {Sales \& Marketing Intern}{June 2016 -- September 2016}
...
%    {\textbf{RSVP} $|$ \cvtag{Python}\cvtag{Flask}\cvtag{Bootstrap}\cvtag{OAuth}\cvtag{Heruko}}{\faGithub{\href{https://github.com/grantwforsythe/gym-bot}{ grantwforsythe/gym-bot}}}
%    \resumeItemListStart
